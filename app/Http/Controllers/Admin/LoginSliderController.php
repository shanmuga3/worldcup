...
class LoginSliderController extends Controller
{
	...
	*/
	...
	{
		$this->view_data['main_title'] = Lang::get('admin_messages.sliders.manage_login_sliders');
		$this->view_data['sub_title'] = Lang::get('admin_messages.navigation.login_sliders');
	...
	*/
	...
	{
		$this->view_data['sub_title'] = Lang::get('admin_messages.sliders.add_slider');
	...
	*/
	...
	{
		$this->view_data['sub_title'] = Lang::get('admin_messages.sliders.edit_slider');
