...
class MetaController extends Controller
{
    ...
    public function __construct()
    {
        $this->view_data['translatable_fields'] = $this->translatable_fields = collect([
            ['key' => 'title', 'title' => Lang::get('admin_messages.fields.title'),'type' => 'text','rules' => 'required|max:100'],
            ['key' => 'description', 'title' => Lang::get('admin_messages.fields.description'),'type' => 'textarea'],
        ]);
        $this->view_data['main_title']  = Lang::get('admin_messages.metas.manage_metas');
        $this->view_data['sub_title'] = Lang::get('admin_messages.navigation.metas');
    ...
    {
        $this->view_data['sub_title'] = Lang::get('admin_messages.metas.edit_meta');
    ...
    protected function validateRequest($request_data, $id = '')
    {
        ...
        $attributes = array(
            'title' => Lang::get('admin_messages.fields.title'),
        );
