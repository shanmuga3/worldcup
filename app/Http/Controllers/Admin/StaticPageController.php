...
class StaticPageController extends Controller
{
	...
	*/
	public function __construct()
	{
		$this->view_data['translatable_fields'] = $this->translatable_fields = collect([
			['key' => 'name', 'title' => Lang::get('admin_messages.fields.name'),'type' => 'text','rules' => 'required|max:30'],
			['key' => 'content', 'title' => Lang::get('admin_messages.fields.content'),'type' => 'textarea', 'class' => 'rich-text-editor','id' => 'rich-text-editor','rules' => 'required'],
		]);
		$this->view_data['main_title'] = Lang::get('admin_messages.static_pages.manage_static_pages');
		$this->view_data['active_menu'] = 'pages';
		$this->view_data['sub_title'] = Lang::get('admin_messages.navigation.static_pages');
	}
	...
	*/
	...
	{
		$this->view_data['sub_title'] = Lang::get('admin_messages.static_pages.add_static_page');
	...
	*/
	...
	{
		$this->view_data['sub_title'] = Lang::get('admin_messages.static_pages.edit_static_page');
