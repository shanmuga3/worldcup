...
class SocialMediaController extends Controller
{
    ...
    {
        $this->view_data['main_title'] = Lang::get('admin_messages.social_media_links.manage_social_media_links');
        $this->view_data['sub_title']   = Lang::get('admin_messages.social_media_links.social_media_links');
