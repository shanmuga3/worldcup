    ...
    public function getMatches(Request $request)
    {
        ...
        $matches = $matches->map(function($match) {
            return [
                ...
                'first_team_formatted_name' => $match->first_team->name,
                'first_team_image' => $match->first_team->image_src,
                'second_team_formatted_name' => $match->second_team->name,
    ...
    public function getPreviousGuesses(Request $request)
    {
        ...
        $guesses = $user_guesses->map(function($guess) {
            return [
                ...
                'first_team_formatted_name' => $guess->match->first_team->name,
                'first_team_image' => $guess->match->first_team->image_src,
                'second_team_formatted_name' => $guess->match->second_team->name,
