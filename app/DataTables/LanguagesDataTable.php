...
class LanguagesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action',function($query) {
            $edit = auth()->guard('admin')->user()->can('update-languages') ? '<a href="'.route('admin.languages.edit',['id' => $query->id]).'" class=""> <i class="fa fa-edit"></i> </a>' : '';
            $delete = auth()->guard('admin')->user()->can('delete-languages') ? '<a href="" data-action="'.route('admin.languages.delete',['id' => $query->id]).'" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"> <i class="fa fa-times"></i> </a>' : '';
            return $edit." &nbsp; ".$delete;
        });
    }
